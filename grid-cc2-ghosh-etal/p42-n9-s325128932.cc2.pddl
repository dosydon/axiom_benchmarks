(DEFINE (PROBLEM N9-S325128932) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C3 - CELL C2 - CELL C0 - CELL B3 - CELL B2 - CELL B1 -
  CELL B0 - CELL A3 - CELL A2 - CELL A1 - CELL A0 - CELL RIGHT - SIDE LEFT -
  SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A0) (PROC A1) (PROC A2) (PROC A3) (PROC B0) (PROC B1) (PROC B2)
  (PROC B3) (DISPENSER C0) (DISPENSER C2) (PROC C3) (AVAILABLE A0)
  (AVAILABLE A1) (AVAILABLE A2) (AVAILABLE A3) (AVAILABLE B0) (AVAILABLE B1)
  (AVAILABLE B2) (AVAILABLE B3) (REJECT C0 LEFT) (REJECT C0 RIGHT)
  (REJECT C0 UP) (REJECT C0 DOWN) (REJECT C2 LEFT) (REJECT C2 RIGHT)
  (REJECT C2 UP) (REJECT C2 DOWN) (AVAILABLE C3) (REJECT BORDER LEFT)
  ...
  (NEIGHBOUR UP C2 BORDER) (NEIGHBOUR RIGHT BORDER C3)
