(DEFINE (PROBLEM N3-S248059080) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL B1 - CELL B0 - CELL A1 - CELL A0 - CELL RIGHT - SIDE
  LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A0) (PROC A1) (DISPENSER B0) (PROC B1) (AVAILABLE A0)
  (AVAILABLE A1) (REJECT B0 LEFT) (REJECT B0 RIGHT) (REJECT B0 UP)
  (REJECT B0 DOWN) (AVAILABLE B1) (REJECT BORDER LEFT) (REJECT BORDER RIGHT)
