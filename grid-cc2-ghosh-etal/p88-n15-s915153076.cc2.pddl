(DEFINE (PROBLEM N15-S915153076) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL G4 - CELL G3 - CELL G2 - CELL G1 - CELL G0 - CELL F3 -
  CELL F2 - CELL F1 - CELL F0 - CELL E3 - CELL E2 - CELL E1 - CELL E0 - CELL D2
  - CELL D1 - CELL D0 - CELL C2 - CELL C1 - CELL RIGHT - SIDE LEFT - SIDE DOWN
  - SIDE UP - SIDE)
 (:INIT (DISPENSER C1) (DISPENSER C2) (PROC D0) (PROC D1) (PROC D2) (PROC E0)
  (PROC E1) (PROC E2) (PROC E3) (PROC F0) (PROC F1) (PROC F2) (DISPENSER F3)
  (PROC G0) (PROC G1) (PROC G2) (PROC G3) (PROC G4) (REJECT C1 LEFT)
  (REJECT C1 RIGHT) (REJECT C1 UP) (REJECT C1 DOWN) (REJECT C2 LEFT)
  (REJECT C2 RIGHT) (REJECT C2 UP) (REJECT C2 DOWN) (AVAILABLE D0)
  (AVAILABLE D1) (AVAILABLE D2) (AVAILABLE E0) (AVAILABLE E1) (AVAILABLE E2)
  (AVAILABLE E3) (AVAILABLE F0) (AVAILABLE F1) (AVAILABLE F2) (REJECT F3 LEFT)
  (REJECT F3 RIGHT) (REJECT F3 UP) (REJECT F3 DOWN) (AVAILABLE G0)
  ...
  (NEIGHBOUR DOWN F0 E0) (NEIGHBOUR UP E0 F0) (NEIGHBOUR RIGHT E2 E1)
  (NEIGHBOUR LEFT E1 E2) (NEIGHBOUR DOWN F1 E1) (NEIGHBOUR UP E1 F1)
  ...
  (NEIGHBOUR UP F0 G0) (NEIGHBOUR RIGHT F2 F1) (NEIGHBOUR LEFT F1 F2)
  ...
  (NEIGHBOUR UP F3 G3) (NEIGHBOUR LEFT BORDER G0) (NEIGHBOUR RIGHT G0 BORDER)
  ...
  (NEIGHBOUR LEFT G4 BORDER) (NEIGHBOUR UP BORDER G4)
