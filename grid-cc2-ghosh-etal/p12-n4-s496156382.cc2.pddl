(DEFINE (PROBLEM N4-S496156382) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL B2 - CELL B1 - CELL A2 - CELL A1 - CELL A0 - CELL
  RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (DISPENSER A0) (PROC A1) (PROC A2) (PROC B1) (PROC B2) (REJECT A0 LEFT)
  (REJECT A0 RIGHT) (REJECT A0 UP) (REJECT A0 DOWN) (AVAILABLE A1)
  (AVAILABLE A2) (AVAILABLE B1) (AVAILABLE B2) (REJECT BORDER LEFT)
  ...
  (NEIGHBOUR UP B1 BORDER) (NEIGHBOUR RIGHT BORDER B2)
