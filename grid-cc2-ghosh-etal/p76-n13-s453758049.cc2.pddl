(DEFINE (PROBLEM N13-S453758049) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL D1 - CELL D0 - CELL C5 - CELL C4 - CELL C3 - CELL C2 -
  CELL C1 - CELL C0 - CELL B4 - CELL B3 - CELL B2 - CELL B1 - CELL B0 - CELL A3
  - CELL A2 - CELL A1 - CELL RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A1) (PROC A2) (DISPENSER A3) (PROC B0) (PROC B1) (PROC B2)
  (PROC B3) (PROC B4) (PROC C0) (PROC C1) (PROC C2) (DISPENSER C3) (PROC C4)
  (DISPENSER C5) (PROC D0) (PROC D1) (AVAILABLE A1) (AVAILABLE A2)
  (REJECT A3 LEFT) (REJECT A3 RIGHT) (REJECT A3 UP) (REJECT A3 DOWN)
  (AVAILABLE B0) (AVAILABLE B1) (AVAILABLE B2) (AVAILABLE B3) (AVAILABLE B4)
  (AVAILABLE C0) (AVAILABLE C1) (AVAILABLE C2) (REJECT C3 LEFT)
  (REJECT C3 RIGHT) (REJECT C3 UP) (REJECT C3 DOWN) (AVAILABLE C4)
  (REJECT C5 LEFT) (REJECT C5 RIGHT) (REJECT C5 UP) (REJECT C5 DOWN)
  (AVAILABLE D0) (AVAILABLE D1) (REJECT BORDER LEFT) (REJECT BORDER RIGHT)
  (REJECT BORDER UP) (REJECT BORDER DOWN) (NEIGHBOUR LEFT BORDER A1)
  (NEIGHBOUR RIGHT A1 BORDER) (NEIGHBOUR RIGHT A2 A1) (NEIGHBOUR LEFT A1 A2)
  ...
  (NEIGHBOUR UP B4 C4) (NEIGHBOUR LEFT BORDER C0) (NEIGHBOUR RIGHT C0 BORDER)
  ...
  (NEIGHBOUR LEFT D1 BORDER) (NEIGHBOUR DOWN BORDER D1)
