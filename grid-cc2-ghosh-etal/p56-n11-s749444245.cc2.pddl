(DEFINE (PROBLEM N11-S749444245) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL D3 - CELL D2 - CELL D1 - CELL C3 - CELL C2 - CELL C1 -
  CELL C0 - CELL B3 - CELL B2 - CELL B1 - CELL B0 - CELL A3 - CELL A2 - CELL
  RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (DISPENSER A2) (PROC A3) (PROC B0) (PROC B1) (DISPENSER B2) (PROC B3)
  (PROC C0) (PROC C1) (PROC C2) (PROC C3) (PROC D1) (PROC D2) (PROC D3)
  (REJECT A2 LEFT) (REJECT A2 RIGHT) (REJECT A2 UP) (REJECT A2 DOWN)
  (AVAILABLE A3) (AVAILABLE B0) (AVAILABLE B1) (REJECT B2 LEFT)
  (REJECT B2 RIGHT) (REJECT B2 UP) (REJECT B2 DOWN) (AVAILABLE B3)
  (AVAILABLE C0) (AVAILABLE C1) (AVAILABLE C2) (AVAILABLE C3) (AVAILABLE D1)
  ...
  (NEIGHBOUR DOWN C3 B3) (NEIGHBOUR UP B3 C3) (NEIGHBOUR LEFT BORDER C0)
  ...
  (NEIGHBOUR UP C2 D2) (NEIGHBOUR RIGHT BORDER C3) (NEIGHBOUR LEFT C3 BORDER)
  (NEIGHBOUR DOWN D3 C3) (NEIGHBOUR UP C3 D3) (NEIGHBOUR LEFT BORDER D1)
  (NEIGHBOUR RIGHT D1 BORDER) (NEIGHBOUR RIGHT D2 D1) (NEIGHBOUR LEFT D1 D2)
