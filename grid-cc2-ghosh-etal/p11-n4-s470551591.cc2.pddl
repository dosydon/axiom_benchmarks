(DEFINE (PROBLEM N4-S470551591) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL B1 - CELL B0 - CELL A2 - CELL A1 - CELL A0 - CELL
  RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A0) (PROC A1) (DISPENSER A2) (PROC B0) (PROC B1) (AVAILABLE A0)
  (AVAILABLE A1) (REJECT A2 LEFT) (REJECT A2 RIGHT) (REJECT A2 UP)
  (REJECT A2 DOWN) (AVAILABLE B0) (AVAILABLE B1) (REJECT BORDER LEFT)
