(DEFINE (PROBLEM N4-S404422661) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C2 - CELL B2 - CELL B1 - CELL A2 - CELL A1 - CELL
  RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A1) (PROC A2) (PROC B1) (PROC B2) (DISPENSER C2) (AVAILABLE A1)
  (AVAILABLE A2) (AVAILABLE B1) (AVAILABLE B2) (REJECT C2 LEFT)
  (REJECT C2 RIGHT) (REJECT C2 UP) (REJECT C2 DOWN) (REJECT BORDER LEFT)
