(DEFINE (PROBLEM N8-S177708726) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C3 - CELL B4 - CELL B3 - CELL B2 - CELL B1 - CELL B0 -
  CELL A3 - CELL A2 - CELL A1 - CELL A0 - CELL RIGHT - SIDE LEFT - SIDE DOWN -
  SIDE UP - SIDE)
 (:INIT (PROC A0) (PROC A1) (PROC A2) (DISPENSER A3) (PROC B0) (PROC B1)
  (PROC B2) (PROC B3) (DISPENSER B4) (PROC C3) (AVAILABLE A0) (AVAILABLE A1)
  (AVAILABLE A2) (REJECT A3 LEFT) (REJECT A3 RIGHT) (REJECT A3 UP)
  (REJECT A3 DOWN) (AVAILABLE B0) (AVAILABLE B1) (AVAILABLE B2) (AVAILABLE B3)
  (REJECT B4 LEFT) (REJECT B4 RIGHT) (REJECT B4 UP) (REJECT B4 DOWN)
  (AVAILABLE C3) (REJECT BORDER LEFT) (REJECT BORDER RIGHT) (REJECT BORDER UP)
