(DEFINE (PROBLEM N4-S377205029) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C2 - CELL C1 - CELL C0 - CELL B2 - CELL B1 - CELL
  RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC B1) (DISPENSER B2) (PROC C0) (PROC C1) (PROC C2) (AVAILABLE B1)
  (REJECT B2 LEFT) (REJECT B2 RIGHT) (REJECT B2 UP) (REJECT B2 DOWN)
  (AVAILABLE C0) (AVAILABLE C1) (AVAILABLE C2) (REJECT BORDER LEFT)
