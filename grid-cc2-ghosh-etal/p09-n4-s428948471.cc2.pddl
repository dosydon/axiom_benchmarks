(DEFINE (PROBLEM N4-S428948471) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C0 - CELL B1 - CELL B0 - CELL A1 - CELL A0 - CELL
  RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A0) (PROC A1) (PROC B0) (DISPENSER B1) (PROC C0) (AVAILABLE A0)
  (AVAILABLE A1) (AVAILABLE B0) (REJECT B1 LEFT) (REJECT B1 RIGHT)
  (REJECT B1 UP) (REJECT B1 DOWN) (AVAILABLE C0) (REJECT BORDER LEFT)
