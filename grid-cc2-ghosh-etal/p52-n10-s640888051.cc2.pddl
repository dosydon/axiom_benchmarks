(DEFINE (PROBLEM N10-S640888051) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C2 - CELL C1 - CELL C0 - CELL B3 - CELL B2 - CELL B1 -
  CELL B0 - CELL A4 - CELL A3 - CELL A2 - CELL A1 - CELL A0 - CELL RIGHT - SIDE
  LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A0) (PROC A1) (PROC A2) (PROC A3) (PROC A4) (PROC B0) (PROC B1)
  (PROC B2) (DISPENSER B3) (PROC C0) (DISPENSER C1) (PROC C2) (AVAILABLE A0)
  (AVAILABLE A1) (AVAILABLE A2) (AVAILABLE A3) (AVAILABLE A4) (AVAILABLE B0)
  (AVAILABLE B1) (AVAILABLE B2) (REJECT B3 LEFT) (REJECT B3 RIGHT)
  (REJECT B3 UP) (REJECT B3 DOWN) (AVAILABLE C0) (REJECT C1 LEFT)
