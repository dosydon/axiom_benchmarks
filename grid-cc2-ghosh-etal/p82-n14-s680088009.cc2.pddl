(DEFINE (PROBLEM N14-S680088009) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL D2 - CELL D1 - CELL C4 - CELL C3 - CELL C2 - CELL C1 -
  CELL C0 - CELL B4 - CELL B3 - CELL B2 - CELL B1 - CELL B0 - CELL A4 - CELL A3
  - CELL A2 - CELL A1 - CELL A0 - CELL RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP
  - SIDE)
 (:INIT (PROC A0) (PROC A1) (PROC A2) (PROC A3) (DISPENSER A4) (PROC B0)
  (PROC B1) (PROC B2) (PROC B3) (PROC B4) (DISPENSER C0) (PROC C1) (PROC C2)
  (PROC C3) (PROC C4) (DISPENSER D1) (PROC D2) (AVAILABLE A0) (AVAILABLE A1)
  (AVAILABLE A2) (AVAILABLE A3) (REJECT A4 LEFT) (REJECT A4 RIGHT)
  (REJECT A4 UP) (REJECT A4 DOWN) (AVAILABLE B0) (AVAILABLE B1) (AVAILABLE B2)
  (AVAILABLE B3) (AVAILABLE B4) (REJECT C0 LEFT) (REJECT C0 RIGHT)
  (REJECT C0 UP) (REJECT C0 DOWN) (AVAILABLE C1) (AVAILABLE C2) (AVAILABLE C3)
  (AVAILABLE C4) (REJECT D1 LEFT) (REJECT D1 RIGHT) (REJECT D1 UP)
  (REJECT D1 DOWN) (AVAILABLE D2) (REJECT BORDER LEFT) (REJECT BORDER RIGHT)
  ...
  (NEIGHBOUR UP A4 B4) (NEIGHBOUR LEFT BORDER B0) (NEIGHBOUR RIGHT B0 BORDER)
  ...
  (NEIGHBOUR DOWN C4 B4) (NEIGHBOUR UP B4 C4) (NEIGHBOUR LEFT BORDER C0)
  (NEIGHBOUR RIGHT C0 BORDER) (NEIGHBOUR RIGHT C1 C0) (NEIGHBOUR LEFT C0 C1)
  (NEIGHBOUR DOWN BORDER C0) (NEIGHBOUR UP C0 BORDER) (NEIGHBOUR RIGHT C2 C1)
  (NEIGHBOUR LEFT C1 C2) (NEIGHBOUR DOWN D1 C1) (NEIGHBOUR UP C1 D1)
  (NEIGHBOUR RIGHT C3 C2) (NEIGHBOUR LEFT C2 C3) (NEIGHBOUR DOWN D2 C2)
  (NEIGHBOUR UP C2 D2) (NEIGHBOUR RIGHT C4 C3) (NEIGHBOUR LEFT C3 C4)
  ...
  (NEIGHBOUR RIGHT D2 D1) (NEIGHBOUR LEFT D1 D2) (NEIGHBOUR DOWN BORDER D1)
  (NEIGHBOUR UP D1 BORDER) (NEIGHBOUR RIGHT BORDER D2)
  (NEIGHBOUR LEFT D2 BORDER) (NEIGHBOUR DOWN BORDER D2)
