(DEFINE (PROBLEM N4-S448265659) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C2 - CELL C1 - CELL C0 - CELL B2 - CELL B0 - CELL
  RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC B0) (DISPENSER B2) (PROC C0) (PROC C1) (PROC C2) (AVAILABLE B0)
  ...
  (NEIGHBOUR RIGHT BORDER B0) (NEIGHBOUR LEFT B0 BORDER)
  (NEIGHBOUR UP BORDER B0) (NEIGHBOUR DOWN B0 BORDER) (NEIGHBOUR DOWN C0 B0)
