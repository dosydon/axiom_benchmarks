(DEFINE (PROBLEM N11-S819788869) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL D1 - CELL D0 - CELL C3 - CELL C1 - CELL C0 - CELL B3 -
  CELL B2 - CELL B1 - CELL B0 - CELL A3 - CELL A2 - CELL A1 - CELL A0 - CELL
  RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A0) (PROC A1) (PROC A2) (DISPENSER A3) (PROC B0) (PROC B1)
  (PROC B2) (PROC B3) (PROC C0) (PROC C1) (DISPENSER C3) (PROC D0) (PROC D1)
  (AVAILABLE A0) (AVAILABLE A1) (AVAILABLE A2) (REJECT A3 LEFT)
  (REJECT A3 RIGHT) (REJECT A3 UP) (REJECT A3 DOWN) (AVAILABLE B0)
