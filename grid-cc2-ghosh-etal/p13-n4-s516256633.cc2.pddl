(DEFINE (PROBLEM N4-S516256633) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C1 - CELL B1 - CELL B0 - CELL A1 - CELL A0 - CELL
  RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A0) (PROC A1) (PROC B0) (PROC B1) (DISPENSER C1) (AVAILABLE A0)
  (AVAILABLE A1) (AVAILABLE B0) (AVAILABLE B1) (REJECT C1 LEFT)
  (REJECT C1 RIGHT) (REJECT C1 UP) (REJECT C1 DOWN) (REJECT BORDER LEFT)
  ...
  (NEIGHBOUR LEFT B1 BORDER) (NEIGHBOUR DOWN C1 B1) (NEIGHBOUR UP B1 C1)
