(DEFINE (PROBLEM N6-S770593510) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C1 - CELL B2 - CELL B1 - CELL B0 - CELL A2 - CELL A1 -
  CELL A0 - CELL RIGHT - SIDE LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (PROC A0) (PROC A1) (PROC A2) (PROC B0) (PROC B1) (PROC B2)
  (DISPENSER C1) (AVAILABLE A0) (AVAILABLE A1) (AVAILABLE A2) (AVAILABLE B0)
  (AVAILABLE B1) (AVAILABLE B2) (REJECT C1 LEFT) (REJECT C1 RIGHT)
  (REJECT C1 UP) (REJECT C1 DOWN) (REJECT BORDER LEFT) (REJECT BORDER RIGHT)
  ...
  (NEIGHBOUR LEFT B2 BORDER) (NEIGHBOUR DOWN BORDER B2)
  (NEIGHBOUR UP B2 BORDER) (NEIGHBOUR LEFT BORDER C1)
  (NEIGHBOUR RIGHT C1 BORDER) (NEIGHBOUR RIGHT BORDER C1)
