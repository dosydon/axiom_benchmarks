(DEFINE (PROBLEM N3-S312536409) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL B1 - CELL B0 - CELL A1 - CELL A0 - CELL RIGHT - SIDE
  LEFT - SIDE DOWN - SIDE UP - SIDE)
 (:INIT (DISPENSER A0) (PROC A1) (PROC B0) (PROC B1) (REJECT A0 LEFT)
  (REJECT A0 RIGHT) (REJECT A0 UP) (REJECT A0 DOWN) (AVAILABLE A1)
  (AVAILABLE B0) (AVAILABLE B1) (REJECT BORDER LEFT) (REJECT BORDER RIGHT)
