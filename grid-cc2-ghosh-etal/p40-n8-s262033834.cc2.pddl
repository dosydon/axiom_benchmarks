(DEFINE (PROBLEM N8-S262033834) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL D3 - CELL D2 - CELL D1 - CELL D0 - CELL C3 - CELL C2 -
  CELL C1 - CELL C0 - CELL B2 - CELL B1 - CELL RIGHT - SIDE LEFT - SIDE DOWN -
  SIDE UP - SIDE)
 (:INIT (DISPENSER B1) (PROC B2) (PROC C0) (PROC C1) (PROC C2) (DISPENSER C3)
  (PROC D0) (PROC D1) (PROC D2) (PROC D3) (REJECT B1 LEFT) (REJECT B1 RIGHT)
  (REJECT B1 UP) (REJECT B1 DOWN) (AVAILABLE B2) (AVAILABLE C0) (AVAILABLE C1)
  (AVAILABLE C2) (REJECT C3 LEFT) (REJECT C3 RIGHT) (REJECT C3 UP)
  (REJECT C3 DOWN) (AVAILABLE D0) (AVAILABLE D1) (AVAILABLE D2) (AVAILABLE D3)
  (REJECT BORDER LEFT) (REJECT BORDER RIGHT) (REJECT BORDER UP)
  (REJECT BORDER DOWN) (NEIGHBOUR LEFT BORDER B1) (NEIGHBOUR RIGHT B1 BORDER)
  ...
  (NEIGHBOUR DOWN C0 BORDER) (NEIGHBOUR DOWN D0 C0) (NEIGHBOUR UP C0 D0)
  (NEIGHBOUR RIGHT C2 C1) (NEIGHBOUR LEFT C1 C2) (NEIGHBOUR DOWN D1 C1)
  ...
  (NEIGHBOUR LEFT C3 BORDER) (NEIGHBOUR UP BORDER C3)
