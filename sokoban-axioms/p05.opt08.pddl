(DEFINE (PROBLEM P095-MICROBAN-SEQUENTIAL) (:DOMAIN SOKOBAN-SEQUENTIAL)
 (:OBJECTS STONE-08 - STONE STONE-07 - STONE STONE-06 - STONE STONE-05 - STONE
  STONE-04 - STONE STONE-03 - STONE STONE-02 - STONE STONE-01 - STONE POS-8-8 -
  ...
  - DIRECTION)
 (:INIT (IS-GOAL POS-3-3) (IS-GOAL POS-3-6) (IS-GOAL POS-4-4) (IS-GOAL POS-4-5)
  (IS-GOAL POS-5-4) (IS-GOAL POS-5-5) (IS-GOAL POS-6-3) (IS-GOAL POS-6-6)
  ...
  (IS-NONGOAL POS-3-4) (IS-NONGOAL POS-3-5) (IS-NONGOAL POS-3-7)
  (IS-NONGOAL POS-3-8) (IS-NONGOAL POS-4-1) (IS-NONGOAL POS-4-2)
  (IS-NONGOAL POS-4-3) (IS-NONGOAL POS-4-6) (IS-NONGOAL POS-4-7)
  (IS-NONGOAL POS-4-8) (IS-NONGOAL POS-5-1) (IS-NONGOAL POS-5-2)
  (IS-NONGOAL POS-5-3) (IS-NONGOAL POS-5-6) (IS-NONGOAL POS-5-7)
  (IS-NONGOAL POS-5-8) (IS-NONGOAL POS-6-1) (IS-NONGOAL POS-6-2)
  (IS-NONGOAL POS-6-4) (IS-NONGOAL POS-6-5) (IS-NONGOAL POS-6-7)
  (IS-NONGOAL POS-6-8) (IS-NONGOAL POS-7-1) (IS-NONGOAL POS-7-2)
  (IS-NONGOAL POS-7-3) (IS-NONGOAL POS-7-4) (IS-NONGOAL POS-7-5)
  (IS-NONGOAL POS-7-6) (IS-NONGOAL POS-7-7) (IS-NONGOAL POS-7-8)
  (IS-NONGOAL POS-8-1) (IS-NONGOAL POS-8-2) (IS-NONGOAL POS-8-3)
  (IS-NONGOAL POS-8-4) (IS-NONGOAL POS-8-5) (IS-NONGOAL POS-8-6)
  (IS-NONGOAL POS-8-7) (IS-NONGOAL POS-8-8) (MOVE-DIR POS-2-2 POS-2-3 DIR-DOWN)
  ...
  (MOVE-DIR POS-7-7 POS-7-6 DIR-UP) (AT PLAYER-01 POS-2-2)
  (AT STONE-01 POS-4-3) (AT STONE-02 POS-5-3) (AT STONE-03 POS-3-4)
  (AT STONE-04 POS-6-4) (AT STONE-05 POS-3-5) (AT STONE-06 POS-6-5)
  (AT STONE-07 POS-4-6) (AT STONE-08 POS-5-6) (= (TOTAL-COST) 0))
 (:GOAL
